...
import { ReverseFormula } from '@/components/advancedlevelwheel/ReverseFormula';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8 flex space-x-4">
          ...
          <Link href="/advanced-level-wheel/formula-builder" className="px-4 py-2 bg-gray-200 rounded">Formula Builder</Link>
          <Link href="/advanced-level-wheel/reverse-formula" className="px-4 py-2 bg-pink-500 text-white rounded">Reverse Formula</Link>
