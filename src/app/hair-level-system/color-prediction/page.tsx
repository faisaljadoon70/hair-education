    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex space-x-4 mb-8">
          ...
          <Link href="/hair-level-system/color-prediction" className="px-4 py-2 bg-pink-500 text-white rounded-md">Color Prediction</Link>
        ...
        {/* Content */}
        <div>
          <h2 className="text-2xl font-bold mb-6">Color Prediction</h2>
          {/* Add content here */}
        </div>
      </div>
    </div>
